  ...
  return (
    <li className='p-3 my-5 bg-slate-200' key={post.id}>
     <h1 className='text-2xl font-bold'>{post.title}</h1>
      ...
      <div className='pt-5'>
        <button className='text-blue-700 mr-3'
         onClick={() => setOpenModalEdit(true)}>Edit</button>

     <Modal modalOpen={openModalEdit} setModalOpen={setOpenModalEdit}>
      <form className='w-full' onSubmit={handleEditSubmit}>

        <h1 className='text-2xl pb-3'>Add Nes Post</h1>
        ...
        <input
          ...
          <button 
          type="submit" className='bg-blue-500 text-white px-5 py-2'>Submit</button>
      </form>
    </Modal>
